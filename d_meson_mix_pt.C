...
void d_meson_mix_pt(TString filename = "results_all.root", float inc_stat = 1, double Ntrig = 41E6) {
	TLatex tx1;
	tx1.SetNDC();
	//int bin_array[] = {1,70,110,160,220,300,500,800};
	//int bin_array[] = {1,70,110,160,220,800};
	//int bin_array[] = {1,110,220,800};
	/*
	   const int n_pt = 5;
	   int bin_array[] = {1,70,120,170,220,800};
	   */
	/*
	   const int n_pt = 4;
	   int bin_array[] = {50,110,170,220,800};
	//int bin_array[] = {50,100,150,200,800};
	//int bin_array[] = {1,70,110,160,220,800};
	*/
	/*
	const int n_pt = 3;
	int bin_array[] = {50,110,220,500};
	//int bin_array[] = {20,60,120,220};
	...
	*/
	...
	const int n_pt = 2;
	//int bin_array[] = {50,110,220};
	//int bin_array[] = {50,120,220};
	//int bin_array[] = {60,120,220};
	//int bin_array[] = {20,110,210};
	//int bin_array[] = {50,100,200};
	int bin_array[] = {20,110,220};
	//int bin_array[] = {100,200,300};
	//int rebin = 1;
	//int rebin = 4;
	int rebin = 10;
	//int rebin = 20;
	...
	TH2D *h_inv_mass_MIX_Kminus_vs_pt = (TH2D*)(_file0->Get("h_inv_mass_MIX_Kminus_vs_pt"));
	h_inv_mass_MIX_Kminus_vs_pt->Sumw2();
	//h_inv_mass_MIX_Kminus_vs_pt->Rebin(rebin);
	TH2D *h_inv_mass_MIX_Kplus_vs_pt = (TH2D*)(_file0->Get("h_inv_mass_MIX_Kplus_vs_pt"));
	...
	output_file.ReplaceAll(".root","_d_meson_mix_pt.pdf");
	...
	for (int i_pt = 0; i_pt < n_pt; i_pt++) {
		...
		*/
		...
		//double int_us = proj_us->Integral(1100,1550);
		//double int_us = proj_us->Integral(1100,1250);
		/*
		   int int_down = 1100;
		   int int_up = 1250;
		   */
		...
		//double int_mix = proj_mix->Integral(1100,1550);
